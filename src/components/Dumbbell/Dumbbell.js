...
class Dumbbell extends React.Component {
  ...
  render() {
    ...
    let dot1PercentStyle = { left: "calc(" + this.scale(dot1Percent) + "% - 8px)" };
    let dot1PercentRightStyle = { left: "calc(" + this.scale(dot1Percent) + "% + 10px)" }
    let dot2PercentStyle = { left: "calc(" + this.scale(dot2Percent) + "% - 8px)" };
    let dot2PercentRightStyle = { left: "calc(" + this.scale(dot2Percent) + "% + 10px)" };
